...
\ProvidesFileSVN{$Id: chronos.tex 9893 2023-11-26 03:27:26Z cfrees $}[v0.8 \revinfo]
\GetFileInfoSVN*
...
\svnid{$Id: chronos.tex 9893 2023-11-26 03:27:26Z cfrees $}
...
\end{verbatim}
    ...
    \item\label{method:rename}\chronosdocidx[type=concept,font=\sffamily,idx post=combining package and \string\TeX{}\space SE code in single document with legacy names]{timeline} Alternatively, update all existing \envslabelname{} to use \enviro{chronos} as explained in \cref{method:cy}, if required.
